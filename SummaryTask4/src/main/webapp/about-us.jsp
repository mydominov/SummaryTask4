...
<body>
		...
		<div class="container-fluid">
			...
			<div>
				<ul class="nav navbar-nav">
					<li class="active"><a href="<c:url value="/about-us.jsp"/>">${lang.section1}</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a>
							<form action="about-us.jsp" method="POST">
	...
	<!-- END MENU -->
	<div id="view">
		<img class="pic" alt="Beautiful Kharkiv" src="<c:url value="/resources/pic/aboutus.jpg"/>">
		<h3>${lang.nameofcompany}</h3>
		<p class="text-info">${lang.historyofcompany}</p>
	</div>
</body>
</html>